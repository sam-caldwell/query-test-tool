...
// to determine optimal scoring weights for query-test-tool.
package calibrate
...
type Mutation struct {
	...
	Description string
	Rules       []string // query-test-tool rules this mutation exercises
...
type QueryTemplate struct {
	...
	Rules      []string // query-test-tool rules this query exercises
...
// ScoredResult combines EXPLAIN data with query-test-tool output.
