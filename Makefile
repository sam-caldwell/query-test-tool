...
.PHONY: all clean lint build test install release release/patch release/minor release/major help
...
build: $(BINDIR)/sqlscore $(BINDIR)/calibrate ## Build binaries to bin/
